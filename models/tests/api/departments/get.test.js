...
describe('GET /api/departments', () => {
  ...
  it('Test_1__ / should return all departments', async () => {
  ...
  it('Test_2__ /:id should return one department by :id ', async () => {
  ...
  it('Test_3__ /random should return one random department', async () => {
